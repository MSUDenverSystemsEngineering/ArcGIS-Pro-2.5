...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-MSI -Path "$dirFiles\ArcGISPro.msi" -Parameters 'ALLUSERS=1 ESRI_LICENSE_HOST=VMWAS22.WINAD.MSUDENVER.EDU SOFTWARE_CLASS=Professional AUTHORIZATION_TYPE=CONCURRENT_USE INSTALLDIR="C:\MyArcGISPro\" ENABLEEUEI=0 /qn' -WindowStyle 'Hidden' -PassThru
