...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\ArcGISPro_25_172639" -Parameters "ALLUSERS=1 ESRI_LICENSE_HOST=VMWAS22.WINAD.MSUDENVER.EDU SOFTWARE_CLASS=Professional AUTHORIZATION_TYPE=CONCURRENT_USE ENABLEEUEI=0 /qn" -WindowStyle 'Hidden' -PassThru
